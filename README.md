...
- If you have a CUDA-capable GPU, install the matching `torch` wheel for GPU to speed training.
- If you want a reproducible environment, I can add a `requirements.txt` or `environment.yml` next. Want me to add one?

---
Generated README to explain the project and how to run `nbc.py`.
